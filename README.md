...
- **Review tool gate** — fast-fails early on unresolved major/critical CodeRabbit findings, then re-checks at the end on long runs
...
| `required_reviewers` | No | `""` | Comma-separated review bots (e.g., `coderabbit`) or `*` for all |
